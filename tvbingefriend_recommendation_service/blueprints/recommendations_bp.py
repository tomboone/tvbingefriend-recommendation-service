...
@bp.route(
    route="shows/{show_id}/recommendations", methods=["GET"], auth_level=func.AuthLevel.ANONYMOUS
)
...
def health_check(req: func.HttpRequest) -> func.HttpResponse:
    ...
    return func.HttpResponse(
        json.dumps({"status": "healthy", "service": "tv-recommender-service", "version": "1.0.0"}),
        status_code=200,
        mimetype="application/json",
    )
