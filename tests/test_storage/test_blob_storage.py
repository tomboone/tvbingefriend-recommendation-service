...
class TestBlobStorageClientInit:
    ...
    def test_init_with_connection_string_and_container(self, mock_storage_service):
        ...
        mock_storage_service.return_value.get_blob_service_client.return_value = (
            mock_container_client
        )

        # Act
        client = BlobStorageClient(
            connection_string="test_connection", container_name="test-container"
        )
...
class TestGetBlobClient:
    ...
    def test_get_blob_client_with_explicit_params(self, mock_client_class):
        ...
        # Act
        get_blob_client(connection_string="test_conn", container_name="test-container")

        # Assert
        mock_client_class.assert_called_once_with(
            connection_string="test_conn", container_name="test-container"
        )
    ...
    def test_get_blob_client_uses_env_variable(self, mock_client_class, monkeypatch):
        ...
        # Assert
        mock_client_class.assert_called_once_with(
            connection_string="env_connection", container_name=None
        )
    ...
    def test_get_blob_client_with_none_connection_string(self, mock_client_class, monkeypatch):
        ...
        # Assert
        mock_client_class.assert_called_once_with(connection_string=None, container_name=None)
