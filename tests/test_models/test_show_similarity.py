...
class TestShowSimilarity:
    ...
    def test_show_similarity_creation_with_all_fields(self, test_db_session):
        ...
        # Assert
        retrieved = (
            test_db_session.query(ShowSimilarity).filter_by(show_id=1, similar_show_id=2).first()
        )
    ...
    def test_show_similarity_creation_with_minimal_fields(self, test_db_session):
        ...
        # Arrange & Act
        similarity = ShowSimilarity(show_id=1, similar_show_id=2, similarity_score=0.75)
        test_db_session.add(similarity)
        test_db_session.commit()
    ...
    def test_show_similarity_composite_primary_key(self, test_db_session):
        ...
        # Arrange
        similarity1 = ShowSimilarity(show_id=1, similar_show_id=2, similarity_score=0.8)
        similarity2 = ShowSimilarity(show_id=1, similar_show_id=3, similarity_score=0.7)
        similarity3 = ShowSimilarity(show_id=2, similar_show_id=1, similarity_score=0.6)
    ...
    def test_show_similarity_duplicate_composite_key_raises_error(self, test_db_session):
        ...
        # Act & Assert
        similarity2 = ShowSimilarity(show_id=1, similar_show_id=2, similarity_score=0.9)
    ...
    def test_show_similarity_repr(self):
        ...
        # Arrange
        similarity = ShowSimilarity(show_id=1, similar_show_id=2, similarity_score=0.856)
    ...
    def test_show_similarity_score_bounds(self, test_db_session):
        ...
        retrieved_high = (
            test_db_session.query(ShowSimilarity).filter_by(show_id=1, similar_show_id=3).first()
        )
    ...
    def test_show_similarity_update(self, test_db_session):
        ...
        # Arrange
        similarity = ShowSimilarity(show_id=1, similar_show_id=2, similarity_score=0.7)
        test_db_session.add(similarity)
        test_db_session.commit()
