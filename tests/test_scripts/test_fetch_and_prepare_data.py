...
class TestFetchAllShows:
    ...
    def test_fetch_all_shows_success(self, sample_shows_list):
        ...
        with patch("scripts.fetch_and_prepare_data.ShowDataLoader") as MockLoader:
            ...
            result = fetch_all_shows(
                show_service_url="http://test.com", batch_size=100, max_shows=10
            )
            ...
            mock_loader.get_all_shows.assert_called_once_with(batch_size=100, max_shows=10)
    ...
    def test_fetch_all_shows_with_defaults(self, sample_shows_list):
        ...
        with patch("scripts.fetch_and_prepare_data.ShowDataLoader") as MockLoader:
            ...
            mock_loader.get_all_shows.assert_called_once_with(batch_size=1000, max_shows=None)
    ...
    def test_fetch_all_shows_custom_batch_size(self, sample_shows_list):
        ...
        with patch("scripts.fetch_and_prepare_data.ShowDataLoader") as MockLoader:
            ...
            fetch_all_shows(batch_size=500, max_shows=100)

            mock_loader.get_all_shows.assert_called_once_with(batch_size=500, max_shows=100)
...
class TestPrepareShowData:
    ...
    def test_prepare_show_data_success(self):
        ...
        raw_data = {
            ...
            "summary": ["<p>Show 1 summary</p>", "<p>Show 2 summary</p>", "<p>Show 3 summary</p>"],
            "type": ["Scripted", "Scripted", "Animation"],
            "language": ["English", "English", "English"],
            "status": ["Running", "Ended", "Running"],
            "rating": [{"average": 8.5}, {"average": 7.0}, {"average": None}],
            "network": [{"name": "NBC"}, None, {"name": "ABC"}],
            "webchannel": [None, {"name": "Netflix"}, None],
        }
...
class TestMain:
    ...
    def test_main_success_with_defaults(
        ...
        mock_fetch.assert_called_once_with(show_service_url=None, batch_size=1000, max_shows=None)
    ...
    def test_main_success_with_custom_args(
        ...
        mock_fetch.assert_called_once_with(
            show_service_url="http://custom.com", batch_size=500, max_shows=100
        )
