...
from scripts.upload_to_blob import (
...
class TestUploadProcessedData:
    ...
    def test_upload_processed_data_success(self, mock_blob_client_class, temp_data_dir):
        ...
        mock_blob_client.list_blobs.return_value = [
            f'processed/{f}' for f in test_files
        ]
    ...
    @patch('scripts.upload_to_blob.get_azure_storage_connection_string')
    def test_upload_processed_data_no_connection_string(
    ...
    @patch('scripts.upload_to_blob.BlobStorageClient')
    def test_upload_processed_data_some_files_missing(
    ...
    @patch('scripts.upload_to_blob.BlobStorageClient')
    def test_upload_processed_data_upload_failures(
        self, mock_blob_client_class, temp_data_dir
    ):
    ...
    @patch('scripts.upload_to_blob.BlobStorageClient')
    def test_upload_processed_data_custom_blob_prefix(
        self, mock_blob_client_class, temp_data_dir
    ):
    ...
    @patch('scripts.upload_to_blob.BlobStorageClient')
    def test_upload_processed_data_no_files_exist(
        self, mock_blob_client_class, temp_data_dir
    ):
...
class TestMain:
    ...
    def test_main_success_with_defaults(
        self, mock_parse_args, mock_upload, temp_data_dir
    ):
    ...
    @patch('argparse.ArgumentParser.parse_args')
    @patch('sys.exit')
    def test_main_no_files_uploaded(
    ...
    @patch('scripts.upload_to_blob.upload_processed_data')
    @patch('argparse.ArgumentParser.parse_args')
    def test_main_successful_upload_count(
        self, mock_parse_args, mock_upload, temp_data_dir
    ):
