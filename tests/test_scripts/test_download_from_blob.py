...
from scripts.download_from_blob import download_processed_data, main
...
class TestDownloadProcessedData:
    ...
    def test_download_processed_data_success(self, mock_blob_client_class, temp_data_dir):
        ...
        mock_blob_client.download_directory.assert_called_once_with(
            blob_prefix="processed", local_dir=temp_data_dir
        )
    ...
    def test_download_processed_data_uses_config_defaults(
        ...
        download_processed_data(local_dir=temp_data_dir, blob_prefix="processed")
    ...
    @patch("scripts.download_from_blob.get_azure_storage_connection_string")
    def test_download_processed_data_no_connection_string(self, mock_get_conn, temp_data_dir):
        """Test handling when connection string is not available."""
        mock_get_conn.return_value = None

        result = download_processed_data(local_dir=temp_data_dir, blob_prefix="processed")

        # Should return 0 when no connection string
        assert result == 0

    @patch("scripts.download_from_blob.BlobStorageClient")
    def test_download_processed_data_no_blobs_found(self, mock_blob_client_class, temp_data_dir):
    ...
    @patch("scripts.download_from_blob.BlobStorageClient")
    def test_download_processed_data_creates_local_dir(self, mock_blob_client_class, temp_data_dir):
    ...
    @patch("scripts.download_from_blob.BlobStorageClient")
    def test_download_processed_data_multiple_files(self, mock_blob_client_class, temp_data_dir):
...
class TestMain:
    ...
    def test_main_success_with_defaults(self, mock_parse_args, mock_download, temp_data_dir):
    ...
    @patch("scripts.download_from_blob.download_processed_data")
    @patch("argparse.ArgumentParser.parse_args")
    def test_main_success_with_custom_args(self, mock_parse_args, mock_download, temp_data_dir):
    ...
    @patch("scripts.download_from_blob.download_processed_data")
    @patch("argparse.ArgumentParser.parse_args")
    def test_main_successful_download_count(self, mock_parse_args, mock_download, temp_data_dir):
    ...
    @patch("scripts.download_from_blob.download_processed_data")
    @patch("argparse.ArgumentParser.parse_args")
    def test_main_with_all_parameters(self, mock_parse_args, mock_download, temp_data_dir):
    ...
    @patch("scripts.download_from_blob.download_processed_data")
    @patch("argparse.ArgumentParser.parse_args")
    def test_main_creates_local_directory_path(self, mock_parse_args, mock_download, temp_data_dir):
    ...
    @patch("argparse.ArgumentParser.parse_args")
    @patch("sys.exit")
    def test_main_connection_error(self, mock_exit, mock_parse_args, mock_download, temp_data_dir):
