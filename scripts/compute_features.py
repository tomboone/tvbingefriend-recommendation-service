...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Compute feature matrices from prepared show data'
    )
    parser.add_argument(
        '--input-dir',
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help='Min document frequency for TF-IDF (default: 2)'
    )
    parser.add_argument(
        '--text-max-df',
        type=float,
